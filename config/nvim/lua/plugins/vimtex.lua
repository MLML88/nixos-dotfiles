return {
    ...
    config = function()
        vim.keymap.set('n', '<localleader>ll', '<cmd>VimtexCompile<cr>', { desc = 'Toggle continuous compilation' })
        ...
        vim.keymap.set('n', '<localleader>le', '<cmd>VimtexErrors<cr>', { desc = 'Show errors' })
        vim.keymap.set('n', '<localleader>ls', '<cmd>VimtexStop<cr>', { desc = 'Stop compilation' })
    end,
}
